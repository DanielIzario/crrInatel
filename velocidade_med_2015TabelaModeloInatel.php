		...
		<div class="body-innerwrapper">
			...
			<section id="sp-main-body">
				<div class="container">
					<div class="row">
						<div class = "divSearch">
							<h3 itemprop="name"> Velocidade Média de Internet por Município - 2015 </h3>
							<center>
						...
						<script type="text/javascript">
							...
							function fncMunicipios(response){
								...
								if( qtd>0 ){
									...
									td.setAttribute( 'style', 'width:230px; vertical-align: middle; text-align: center;' );
									tr.appendChild(td);
									...
									var td = document.createElement("td");
									td.appendChild(document.createTextNode( "Velocidade Média" ));
									td.setAttribute( 'style', 'width:110px; vertical-align: middle; text-align: center;' );
									tr.appendChild(td);
