		...
		<div class="body-innerwrapper">
			...
			<section id="sp-main-body">
				<div class="container">
					<div class="row">
						<center>
							<h3 itemprop="name"> Escolas Urbanas sem Internet </h3>
						</center>
						<div id = "outer">
						...
						<script type = "text/javascript">
							...
							function createMap(){
								...
								info.update = function (props) {
									...
									this._div.innerHTML = '<h4>Escolas Urbanas sem Internet &nbsp;&nbsp;&nbsp;</h4>' + (props  ?
										'<b>' + '<i class="info_legenda" style="background:' + getColor(props.urb_semint) + '"></i>' + 
											props.nome + ', ' +  props.uf + '</b><br />' + props.urb_semint + ' escolas</sup>'  : ' ');
								};
							...
							function style(feature) {
								return {
									fillColor: getColor(feature.properties.urb_semint),
									weight: 1,
									opacity: 0.98,
									color: 'grey',
									dashArray: '',
							...
							function zoomToFeature(e) {
								...
								popup = L.popup()
									.setLatLng(e.latlng)
									.setContent('<p>' + prop.nome + ', ' + prop.uf  + '<br/>' + prop.urb_semint + '</p>')
									.openOn(map);
							}
							...
							function style0(feature) {
								var escURB_semint = feature.properties.urb_semint;

								if( escURB_semint >= 0 && escURB_semint < 5 ){
									return {
										fillColor: '#d73027',
										weight: 1,
										opacity: 0.98,
							...
							function style1(feature) {
								...
								if( escURB_semint >= 5 && escURB_semint < 10  ){
									return {
										fillColor: '#f46d43',
										weight: 1,
										opacity: 0.98,
							...
							function style2(feature) {
								...
								if( escURB_semint >= 10 && escURB_semint < 20 ){
									return {
										fillColor: '#fdae61',
										weight: 1,
										opacity: 0.98,
							...
							function style3(feature) {
								...
								if( escURB_semint >= 20 && escURB_semint < 40 ){
									return {
										fillColor: '#fee08b',
										weight: 1,
										opacity: 0.98,
							...
							function style4(feature) {
								...
								if( escURB_semint >= 40 && escURB_semint < 80 ){
									return {
										fillColor: '#d9ef8b',
										weight: 1,
										opacity: 0.98,
							...
							function style5(feature) {
								...
								if( escURB_semint >= 80 && escURB_semint < 160 ){
									return {
										fillColor: '#a6d96a',
										weight: 1,
										opacity: 0.98,
