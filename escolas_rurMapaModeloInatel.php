		...
		<div class="body-innerwrapper">
			...
			<section id="sp-main-body">
				<div class="container">
					<div class="row">
						<center>
							<h3 itemprop="name"> Escolas Rurais por Município </h3>
						</center>
						<div id = "outer">
						...
						<script type = "text/javascript">
							...
							function createMap(){
								...
								info.update = function (props) {
									...
									this._div.innerHTML = '<h4>Escolas Rurais por Município &nbsp;&nbsp;&nbsp;</h4>' + (props  ?
										'<b>' + '<i class="info_legenda" style="background:' + getColor(props.esc_rur) + '"></i>' + 
											props.nome + ', ' +  props.uf + '</b><br />' + props.esc_rur + ' escolas</sup>'  : ' ');
								};
							...
							function style(feature) {
								return {
									fillColor: getColor(feature.properties.esc_rur),
									weight: 1,
									opacity: 0.98,
									color: 'grey',
									dashArray: '',
							...
							function zoomToFeature(e) {
								...
								popup = L.popup()
									.setLatLng(e.latlng)
									.setContent('<p>' + prop.nome + ', ' + prop.uf  + '<br/>' + prop.esc_rur + '</p>')
									.openOn(map);
							}
							...
							function style0(feature) {
								var escRUR = feature.properties.esc_rur;

								if( escRUR >= 0 && escRUR < 15 ){
									return {
										fillColor: '#d73027',
										weight: 1,
										opacity: 0.98,
