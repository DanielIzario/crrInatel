		...
		<div class="body-innerwrapper">
			...
			<section id="sp-main-body">
				<div class="container">
					<div class="row">
						<center>
							<h3 itemprop="name"> Acessos a Banda Larga - 2014 </h3>
						</center>
						<div id = "outer">
						...
						<script type = "text/javascript">
							...
							function createMap(){
								...
								info.update = function (props) {
									...
									this._div.innerHTML = '<h4>Acessos a Banda Larga - 2014 &nbsp;&nbsp;&nbsp;</h4>' + (props  ?
										'<b>' + '<i class="info_legenda" style="background:' + getColor(props.acessos) + '"></i>' + 
											props.nome + ', ' +  props.uf + '</b><br />' + props.acessos + ' acessos</sup>'  : ' ');
								};
							...
							function style(feature) {
								return {
									fillColor: getColor(feature.properties.acessos),
									weight: 1,
									opacity: 0.98,
									color: 'grey',
									dashArray: '',
							...
							function style0(feature) {
								...
								var acesso = feature.properties.acessos;
