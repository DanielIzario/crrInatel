		...
		<div class="body-innerwrapper">
			...
			<section id="sp-main-body">
				<div class="container">
					<div class="row">
						<center>
							<h3 itemprop="name"> Escolas Rurais sem Internet </h3>
						</center>
						<div id = "outer">
						...
						<script type = "text/javascript">
							...
							function createMap(){
								...
								info.update = function (props) {
									...
									this._div.innerHTML = '<h4>Escolas Rurais sem Internet &nbsp;&nbsp;&nbsp;</h4>' + (props  ?
										'<b>' + '<i class="info_legenda" style="background:' + getColor(props.rur_semint) + '"></i>' + 
											props.nome + ', ' +  props.uf + '</b><br />' + props.rur_semint + ' escolas</sup>'  : ' ');
								};
							...
							function style(feature) {
								return {
									fillColor: getColor(feature.properties.rur_semint),
									weight: 1,
									opacity: 0.98,
									color: 'grey',
									dashArray: '',
							...
							function zoomToFeature(e) {
								...
								popup = L.popup()
									.setLatLng(e.latlng)
									.setContent('<p>' + prop.nome + ', ' + prop.uf  + '<br/>' + prop.rur_semint + '</p>')
									.openOn(map);
							}
							...
							function style0(feature) {
								var escRUR_semint = feature.properties.rur_semint;

								if( escRUR_semint >= 0 && escRUR_semint < 5 ){
									return {
										fillColor: '#d73027',
										weight: 1,
										opacity: 0.98,
							...
							function style1(feature) {
								...
								if( escRUR_semint >= 5 && escRUR_semint < 10  ){
									return {
										fillColor: '#f46d43',
										weight: 1,
										opacity: 0.98,
							...
							function style2(feature) {
								...
								if( escRUR_semint >= 10 && escRUR_semint < 20 ){
									return {
										fillColor: '#fdae61',
										weight: 1,
										opacity: 0.98,
							...
							function style3(feature) {
								...
								if( escRUR_semint >= 20 && escRUR_semint < 40 ){
									return {
										fillColor: '#fee08b',
										weight: 1,
										opacity: 0.98,
							...
							function style4(feature) {
								...
								if( escRUR_semint >= 40 && escRUR_semint < 80 ){
									return {
										fillColor: '#d9ef8b',
										weight: 1,
										opacity: 0.98,
							...
							function style5(feature) {
								...
								if( escRUR_semint >= 80 && escRUR_semint < 160 ){
									return {
										fillColor: '#a6d96a',
										weight: 1,
										opacity: 0.98,
