		...
		<div class="body-innerwrapper">
			...
			<section id="sp-main-body">
				<div class="container">
					<div class="row">
						<center>
							<h3 itemprop="name"> População do Brasil por Município - 2014 </h3>
						</center>
						<div id = "outer">
						...
						<script type = "text/javascript">
							...
							function createMap(){
								...
								info.update = function (props) {
									...
									this._div.innerHTML = '<h4>População do Brasil por Município - 2014 &nbsp;&nbsp;&nbsp;</h4>' + (props  ?
							...
							function style(feature) {
								return {
									fillColor: getColor(feature.properties.pop_2014),
									weight: 1,
									opacity: 0.98,
									color: 'grey',
									dashArray: '',
