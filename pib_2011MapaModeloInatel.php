		...
		<div class="body-innerwrapper">
			...
			<section id="sp-main-body">
				<div class="container">
					<div class="row">
						<center>
							<h3 itemprop="name"> Produto Interno Bruto (PIB) - 2011 </h3>
						</center>
						<div id = "outer">
						...
						<script type = "text/javascript">
							...
							function createMap(){
								...
								info.update = function (props) {
									...
									this._div.innerHTML = '<h4>Produto Interno Bruto (PIB) - 2011 &nbsp;&nbsp;&nbsp;</h4>' + (props  ?
										'<b>' + '<i class="info_legenda" style="background:' + getColor(props.pib_2011) + '"></i>' + 
											props.nome + ', ' +  props.uf + '</b><br />' + props.pib_2011 + ' </sup>'  : ' ');
								};

								// Adiciona as informações feitas acima do mapa
								info.addTo(map);
								...
								legend.onAdd = function (map) {
									...
									var div = L.DomUtil.create('div', 'legend'),
										grades = [0, 150000, 250000, 350000, 450000, 550000, 650000];
							...
							function style(feature) {
								return {
									fillColor: getColor(feature.properties.pib_2011),
									weight: 1,
									opacity: 0.98,
									color: 'grey',
									dashArray: '',
							...
							function zoomToFeature(e) {
								...
								popup = L.popup()
									.setLatLng(e.latlng)
									.setContent('<p>' + prop.nome + ', ' + prop.uf  + '<br/>' + prop.pib_2011 + '</p>')
									.openOn(map);
							}
							...
							function style0(feature) {
								var pib = feature.properties.pib_2011;
