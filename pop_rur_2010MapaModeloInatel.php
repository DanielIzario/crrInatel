		...
		<div class="body-innerwrapper">
			...
			<section id="sp-main-body">
				<div class="container">
					<div class="row">
						<center>
							<h3 itemprop="name"> População Rural por Município - 2010 </h3>
						</center>
						<div id = "outer">
						...
						<script type = "text/javascript">
							...
							function createMap(){
								...
								info.update = function (props) {
									...
									this._div.innerHTML = '<h4>População Rural por Município - 2010 &nbsp;&nbsp;&nbsp;</h4>' + (props  ?
										'<b>' + '<i class="info_legenda" style="background:' + getColor(props.poprur2010) + '"></i>' + 
											props.nome + ', ' +  props.uf + '</b><br />' + props.poprur2010 + ' habitantes</sup>'  : ' ');
								};
							...
							function style(feature) {
								return {
									fillColor: getColor(feature.properties.poprur2010),
									weight: 1,
									opacity: 0.98,
									color: 'grey',
									dashArray: '',
							...
							function zoomToFeature(e) {
								...
								popup = L.popup()
									.setLatLng(e.latlng)
									.setContent('<p>' + prop.nome + ', ' + prop.uf  + '<br/>' + prop.poprur2010 + ' habitantes</p>')
									.openOn(map);
							}
							...
							function style0(feature) {
								...
								var pop = feature.properties.poprur2010;
								if( pop < 10000 ){
									return {
										fillColor: '#d0d1e6',
										weight: 1,
