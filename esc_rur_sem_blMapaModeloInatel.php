		...
		<div class="body-innerwrapper">
			...
			<section id="sp-main-body">
				<div class="container">
					<div class="row">
						<center>
							<h3 itemprop="name"> Escolas Rurais sem Banda Larga </h3>
						</center>
						<div id = "outer">
						...
						<script type = "text/javascript">
							...
							function createMap(){
								...
								info.update = function (props) {
									...
									this._div.innerHTML = '<h4>Escolas Rurais sem Banda Larga &nbsp;&nbsp;&nbsp;</h4>' + (props  ?
										'<b>' + '<i class="info_legenda" style="background:' + getColor(props.rur_sem_bl) + '"></i>' + 
											props.nome + ', ' +  props.uf + '</b><br />' + props.rur_sem_bl + ' escolas</sup>'  : ' ');
								};
							...
							function style(feature) {
								return {
									fillColor: getColor(feature.properties.rur_sem_bl),
									weight: 1,
									opacity: 0.98,
									color: 'grey',
									dashArray: '',
							...
							function zoomToFeature(e) {
								...
								popup = L.popup()
									.setLatLng(e.latlng)
									.setContent('<p>' + prop.nome + ', ' + prop.uf  + '<br/>' + prop.rur_sem_bl + '</p>')
									.openOn(map);
							}
							...
							function style0(feature) {
								var escRUR_sembl = feature.properties.rur_sem_bl;

								if( escRUR_sembl >= 0 && escRUR_sembl < 1 ){
									return {
										fillColor: '#d73027',
										weight: 1,
										opacity: 0.98,
							...
							function style1(feature) {
								...
								if( escRUR_sembl >= 1 && escRUR_sembl < 2  ){
									return {
										fillColor: '#f46d43',
										weight: 1,
										opacity: 0.98,
							...
							function style2(feature) {
								...
								if( escRUR_sembl >= 2 && escRUR_sembl < 4 ){
									return {
										fillColor: '#fdae61',
										weight: 1,
										opacity: 0.98,
							...
							function style3(feature) {
								...
								if( escRUR_sembl >= 4 && escRUR_sembl < 8 ){
									return {
										fillColor: '#fee08b',
										weight: 1,
										opacity: 0.98,
							...
							function style4(feature) {
								...
								if( escRUR_sembl >= 8 && escRUR_sembl < 16 ){
									return {
										fillColor: '#d9ef8b',
										weight: 1,
										opacity: 0.98,
							...
							function style5(feature) {
								...
								if( escRUR_sembl >= 16 && escRUR_sembl < 32 ){
									return {
										fillColor: '#a6d96a',
										weight: 1,
										opacity: 0.98,
