		...
		<div class="body-innerwrapper">
			...
			<section id="sp-main-body">
				<div class="container">
					<div class="row">
						<center>
							<h3 itemprop="name"> Municípios com Backbone em Fibra Óptica </h3>
						</center>
						<div id = "outer">
						...
						<script type = "text/javascript">
							...
							function createMap(){
								...
								info.update = function (props) {
									...
									this._div.innerHTML = '<h4>Municípios com Backbone em Fibra Óptica &nbsp;&nbsp;&nbsp;</h4>' + (props  ?
										'<b>' + '<i class="info_legenda" style="background:' + getColor(props.Backbone) + '"></i>' + 
											props.nome + ', ' +  props.uf + '</b><br />' + props.Backbone + ' (0 - Não / 1 - Sim)</sup>'  : ' ');
								};
							...
							function style(feature) {
								return {
									fillColor: getColor(feature.properties.Backbone),
									weight: 1,
									opacity: 0.98,
									color: 'grey',
									dashArray: '',
							...
							function zoomToFeature(e) {
								...
								popup = L.popup()
									.setLatLng(e.latlng)
									.setContent('<p>' + prop.nome + ', ' + prop.uf  + '<br/>' + prop.Backbone + ' (0 - Não / 1 - Sim)</p>')
									.openOn(map);
							}
							...
							function style0(feature) {
								// Propriedade do GEOJson aberto 
								var backbone = feature.properties.Backbone;
								if( backbone == 0){
									return {
										fillColor: '#d0d1e6',
										weight: 1,
